    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->clear_scene, SIGNAL(triggered()), builder, SLOT(clearScene()));
    connect(ui->addTexture, SIGNAL(triggered()), builder, SLOT(addTexture()));
...
void GLMainWindow::connectShaders()
{
    ...
    connect(this->ui->action_TextureShader, SIGNAL(triggered()), glWidget, SLOT(activaTextureShader()));
